 ...
 * Try to add any product in the grid to the cart through the item page.
 * Inside an Item Page, test the product quantity, it should stop at minimum 1 and maximum amount available at the database.
...
* Client: use the SignUp system.
* ADM: gabriel@hotmail.com; psw: 132.
1. Access any product page (Accessories, Cats or Dogs).
 * Try to add any product in the grid to the cart through the item page.
2. Access accessorires product page and enter the _Unique Feature_.
 * Try to add it to the cart.
...
#### *Results*
1. The correct item and quantity should be added to the cart.
2. The correct item and quantity should be added to the cart.
3. On the right side of the Checkout page, there should be the exact items that your cart has.
...
2. Try to sign up using an email already registered (gabriel@hotmail.com).
